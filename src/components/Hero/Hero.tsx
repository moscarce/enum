...
const Hero = () => {
  return (
    <div className="hero-container | py-10 px-14 font-bold max-md:px-4">
        <div className="bg-white bg-opacity-60 w-52 p-2 rounded flex flex-col justify-center items-center gap-2">
            ...
            <div className="bg-white w-[100%] text-center py-2 rounded-md flex justify-center items-center gap-3 cursor-pointer">
                <p>View Profile</p>
